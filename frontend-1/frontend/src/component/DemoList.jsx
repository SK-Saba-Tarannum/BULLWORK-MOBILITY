...
//         <h2 className="text-3xl font-bold text-purple-900 mb-6 text-center">All Demo Bookings</h2>
...
//         <div className="overflow-x-auto max-w-5xl mx-auto bg-white rounded shadow">
...
//             <tbody>
//               {demos.map((demo) => (
//                 <tr key={demo.id} className="border-t">
//                   <td className="px-4 py-2">{demo.name}</td>
//                   <td className="px-4 py-2">{demo.phone}</td>
//                   <td className="px-4 py-2">{demo.email}</td>
//                   <td className="px-4 py-2">{demo.product}</td>
//                   <td className="px-4 py-2">{demo.address}</td>
//                   <td className="px-4 py-2">{demo.message || "—"}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
