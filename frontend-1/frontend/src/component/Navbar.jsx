...
//   return (
//     <>
//       <header className="flex justify-between items-center px-6 py-4 bg-black text-white relative">
//         {/* Logo */}
...
//         {/* Order Button */}
//         <button onClick={()=>{navigate("/order")}} className="bg-gradient-to-r from-purple-400 to-purple-900 hover:opacity-90 text-white px-4 py-2 rounded-md font-medium hidden md:block">
//           ORDER
//         </button>
...
//         {isOpen && (
//           <div className="absolute top-full left-0 w-full bg-black text-white flex flex-col items-center space-y-4 py-4 z-50 md:hidden">
//             <a href="/" className="hover:text-purple-400">HOME</a>
//             <a href="/products" className="hover:text-purple-400">PRODUCTS</a>
//             <a href="/technology" className="hover:text-purple-400">TECHNOLOGY</a>
//             <a href="/aboutus" className="hover:text-purple-400">ABOUT US</a>
//             <a href="/career" className="hover:text-purple-400">CAREERS</a>
//             <button className="bg-gradient-to-r from-purple-400 to-purple-900 hover:opacity-90 text-white px-4 py-2 rounded-md font-medium">
//               ORDER
//             </button>
//           </div>
//         )}
...
//         {/* Mobile Dropdown Menu */}
//         {isOpen && (
//           <div className="absolute top-full left-0 w-full bg-black text-white flex flex-col items-center space-y-4 py-4 z-40 md:hidden">
...
//   return (
//     <>
//       <header className="sticky top-0 z-50 bg-black text-white shadow-md px-4 sm:px-6 py-4 flex justify-between items-center">
//         {/* Logo */}
//         <div className="text-xl tracking-wide flex gap-3 items-center">
//           <img src="/logo.webp" alt="Bullwork Logo" className="h-10 w-auto" />
//           <span className="text-2xl font-semibold whitespace-nowrap">BULLWORK MOBILITY</span>
//         </div>
...
//         {/* Mobile Dropdown Menu */}
//         <div
//           className={`absolute top-full left-0 w-full bg-black text-white transition-all duration-300 ease-in-out ${
//             isOpen ? 'max-h-screen opacity-100 py-4' : 'max-h-0 opacity-0 overflow-hidden'
//           } flex flex-col items-center space-y-4 z-40 md:hidden`}
//         >
//           <a href="/" className="hover:text-purple-400" onClick={() => setIsOpen(false)}>HOME</a>
//           <a href="/products" className="hover:text-purple-400" onClick={() => setIsOpen(false)}>PRODUCTS</a>
//           <a href="/technology" className="hover:text-purple-400" onClick={() => setIsOpen(false)}>TECHNOLOGY</a>
