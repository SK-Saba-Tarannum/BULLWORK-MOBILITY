...
//     image: 'beast.webp', // update path as needed
//   },
//   {
//     name: 'VAMANA',
//     description: 'The Ultimate Unmanned Ground Vehicle',
//     image: 'Vamana Pro.webp', // update path as needed
//   },
// ];
...
//     image:
//       'remote.webp', // Replace with actual image URL
//   },
//   {
...
//       </div>
//       <div>
//         <h2 className="text-4xl font-semibold sm:text-3xl mt-6 mb-2">Unleash electric vehicle's true power with BHAI by your side</h2>
//         <p className="text-purple-700 text-base sm:text-lg mb-10">Experience the future of electric vehicles, seamlessly controlled via mobile app, featuring autonomous navigation guided by mission files</p>
//         {/* <video
//             autoPlay
//             loop
//             muted
...
//           >
//             <source src="https://youtu.be/1fK_k2j4EVU" type="video/mp4" />
//             Your browser does not support the video tag.
//           </video>
//         */}

//           <div className="relative aspect-video w-full mb-6 sm:m-6 max-w-4xl mx-auto rounded-xl overflow-hidden shadow-lg">
//                 <iframe
...
//       <div>
//       <h2 className="text-4xl font-semibold sm:text-3xl mt-6 mb-2">discover bullwork's control system</h2>
//       <p className="text-purple-700 text-base sm:text-lg mb-10">Bullwork offers a variety of unique control options tailored to their vehicles</p>

//       <div className="space-y-10 w-full sm:m-4 max-w-5xl mx-auto flex flex-col justify-center items-center">
//         {control.map((item, index) => (
//           <div
//             key={index}
//             className="flex flex-col md:flex-row bg-white sm:m-4 shadow-md rounded-2xl overflow-hidden m-6 w-full"
//           >
//             {/* Text Content */}
...
//       </section>
//       {/* first slider */}
//       <div className="w-full py-12 bg-[#f8f8f8] text-center flex flex-col items-center">
//       <h2 className="text-2xl md:text-2xl font-semibold uppercase mb-8">
...
//         <button
//           onClick={prevSlide}
//           className="absolute left-0 top-1/2   -translate-y-1/2 bg-white rounded-full shadow  "
//         >
//           <ChevronLeft size={24} />
//         </button>
...
//           alt={dashboardImages[current].alt}
//           className="rounded-2xl shadow-lg w-full h-auto"
//         />

//         <button
//           onClick={nextSlide}
//           className="absolute right-0 top-1/2 -translate-y-1/2 bg-white rounded-full shadow "
//         >
...
//     <section className="bg-[#f9f9fb] py-16 text-center">
